...
famous_foods = [
    "Pizza, especially from Naples, is a globally loved dish made from a flatbread base topped with tomato sauce, cheese, and various toppings.",
    ...
    "Tacos are a staple of Mexican cuisine, consisting of a tortilla folded around fillings like seasoned meat, vegetables, cheese, and salsa.",
    "Sushi is a traditional Japanese dish featuring vinegared rice, often accompanied by raw fish, seaweed, and vegetables, carefully rolled into forms.",
...
def get_famous_food(country):
    ...
    if country in countries:
        ...
        return (
            f"\nThe famous food of {country.capitalize()} is: {famous_foods[index]}\n"
        )
    else:
        return "The country cannot be found. Please check the spelling or try another country."


while True:
    user_input = input(
        "\nPlease enter a country name to see its famous food (or type 'exit' to quit): "
    ).lower()
